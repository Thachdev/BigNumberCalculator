...
public class Number {
    ...
    public boolean isIntegerList() {
        ...
        for (int i = 0; i < listNumber.size(); i++) {
            int currentNumber = listNumber.get(i);
    ...
    // Công thêm 1 cho Number trả về 1 Number
...
//    public static Number chia(Number numberA, Number numberB){
//        
//        String strA = numberA.numberToString();
//        String strB = numberB.numberToString();
//        BigInteger A = new BigInteger(strA);
//        BigInteger B = new BigInteger(strB);
//        BigInteger kq = A.divide(B);
//        String result = "";
//        result = result + kq;
//        Number total = new Number(result);
//        
//        return total;
//    }
    
    public static Number div(Number numberA, Number numberB){
        String result = "";
        char typeA = numberA.integerType;
        char typeB = numberB.integerType;
        numberA.integerType = '+';
        numberB.integerType = '+';
        ...
        String strB = numberB.numberToString();
        String A = "";
        if(Number.numberAThanNumberB(numberA, numberB)){
            for (int i = 0; i < strA.length(); i++){
                A = A + strA.charAt(i);

                Number numA = new Number(A);
                Number numB = new Number(strB);

                if (Number.numberAThanNumberB(numA, numB)){


                    Number numR = division(numA, numB);
                    String rr = numR.numberToString();
                    result = result + rr;


                    Number remander = remainderNumber(numR, numA, numB);

                    A = remander.numberToString();
